package com.buildhappy.downloaderModel.bean;
 ...
 * @see com.buildhappy.processor.PageProcessor
 * @since 0.1.0
 */
public class Site {
    ...
    /**
     * @see com.buildhappy.utils.HttpConstant.Header
     * @deprecated
     */
     ...
     * Because urls are more a Spider's property than Site, move it to {@link SpiderTest#addUrl(String...)}}
     *
     * @param startUrl
     * @return this
     * @see SpiderTest#addUrl(String...)
     * @deprecated
     */
    ...
    /**
     * Add a url to start url.<br>
     * Because urls are more a Spider's property than Site, move it to {@link SpiderTest#addRequest(Request...)}}
     *
     * @param startRequest
     * @return this
     * @see SpiderTest#addRequest(Request...)
     * @deprecated
     */
