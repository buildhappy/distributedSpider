...
public class HBaseUtils {
	 ...
	 * @throws IOException
	 */
	public static void store(String name, String version, String os, String url)
			throws IOException {
		// System.out.println("name:" + name + " version:" + version + " os:" +
		// os + " url:" + url);
		...
		put.add(Bytes.toBytes("info"), Bytes.toBytes("name"),
				Bytes.toBytes(name));
		put.add(Bytes.toBytes("info"), Bytes.toBytes("version"),
				Bytes.toBytes(version));
		// put.add(Bytes.toBytes("info") , Bytes.toBytes("os") ,
		// Bytes.toBytes(os.toString()));
		...
		// }
		// ????????
		boolean res = table.checkAndPut(Bytes.toBytes(name + version),
				Bytes.toBytes("info"), Bytes.toBytes("name"), null, put);
		// table.put(put);
	}
	...
	public static void get(String name, String version) throws IOException {
		...
		byte[] source = res.getValue(Bytes.toBytes("source"),
