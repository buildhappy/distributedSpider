...
public class PropertiesUtil {
	...
	public static int getToDoQueueSize(){
		return Integer.parseInt(pro.getProperty("todo.queue.size"));
	}
	...
	public static String getRouterPubAddress(){
		return pro.getProperty("router.pub.address");
	}
	//use proxy or not
	...
	public static void main(String[] args) {
		...
		System.out.println(PropertiesUtil.getToDoQueueSize());
