...
public class RedisClient {
    private Jedis jedis;//非切片额客户端连接(单机连接)
    private JedisPool jedisPool;//非切片连接池
    private ShardedJedis shardedJedis;//切片额客户端连接(集群连接)
    ...
    public RedisClient(){ 
        ...
        jedis = new Jedis ("127.0.0.1",6379);//连接redis
    ...
    private void initialShardedPool(){
        ...
        shards.add(new JedisShardInfo("127.0.0.1", 6379, "buildhappy"));
        // 构造池
    ...
    private void hashOperate(){ 
        ...
        System.out.println("=============增=============");
        System.out.println("hashs中添加key001和value001键值对：" + jedis.hset("hashs", "key0001", "value001"));
